/**
 * run_preprocessing.cjs
 * Node.js equivalent of process_block_data.py + process_all_nrega.py
 * Auto-runs before `npm run dev` and `npm run build` via package.json predev/prebuild hooks.
 */
const fs = require('fs');
